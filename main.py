...
Label(text='Отправитель:').grid(row=0, column=0, sticky=W)  # Создание метки
sender_email_entry = Entry()
sender_email_entry.grid(row=0, column=1, sticky=W)

Label(text='Получатель:').grid(row=1, column=0, sticky=W)  # метка
recipient_email_entry = Entry()
recipient_email_entry.grid(row=1, column=1, sticky=W)

Label(text='Пароль приложения:').grid(row=2, column=0, sticky=W)  # метка
password_entry = Entry()
password_entry.grid(row=2, column=1, sticky=W)

Label(text='Тема письма:').grid(row=3, column=0, sticky=W)  # метка
subject_entry = Entry()
subject_entry.grid(row=3, column=1, sticky=W)

Label(text='Сообщение:').grid(row=4, column=0, sticky=W)  # метка
